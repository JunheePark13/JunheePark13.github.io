...
if (currentPath.toLowerCase() === 'rsx.html') {
  ...
  if (gallery && !gallery.querySelector('.rsx-full-arm')) {
    ...
    figure.innerHTML = '<img src="../images/RSXArmFull.png" alt="Full CAD assembly of the Robotics for Space Exploration rover arm." loading="lazy" style="display:block;width:100%;height:auto;object-fit:contain"><figcaption>Full CAD assembly of the rover arm in Fusion 360.</figcaption>';
